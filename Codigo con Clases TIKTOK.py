class Coreografia:
    ...
    def __init__(self):
        ...
        # o podrías usarlo para inicializar cosas en el futuro.
        pass
...
# 1. Crear una instancia de la coreografía
mi_baile = Coreografia()

# 2. Ejecutar la secuencia de pasos llamando a los métodos del objeto
...
mi_baile.paso_4(1,2)
mi_baile.paso_5(1,1)
mi_baile.paso_2(1)  # Se repite el paso 2
mi_baile.paso_6(1)
mi_baile.paso_3(1,1)  # Se repite el paso 3
mi_baile.paso_4(1,2)  # Se repite el paso 4
mi_baile.paso_5(1,1)  # Se repite el paso 5
mi_baile.paso_6(1)  # Se repite el paso 6
mi_baile.paso_7(1)
mi_baile.paso_8(1,2)
mi_baile.paso_9(1,2)

# Nota: Tu secuencia original no llamaba a paso_10, así que aquí tampoco lo hacemos.
